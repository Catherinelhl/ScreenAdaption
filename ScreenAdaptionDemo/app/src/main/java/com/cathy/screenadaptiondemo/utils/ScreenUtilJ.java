...
public class ScreenUtilJ {
    ...
    public static void initAppDensity(@NonNull final Application application) {
        ...
        System.out.println(TAG + "---app display metrics:" + appDisplayMetrics);
        //获取状态栏高度
        barHeight = getStatusBarHeight(application);
        System.out.println(TAG + "---bar height:" + barHeight);
        if (appDensity == 0) {
            //初始化的时候赋值
            ...
            application.registerComponentCallbacks(new ComponentCallbacks() {
                ...
                public void onLowMemory() {
                    System.out.println(TAG + "---onLowMemory");
